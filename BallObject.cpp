...
:  GameObject(pos, glm::vec2(radius * 2, radius * 2), std::move(sprite), glm::vec3(1.0f), velocity), _radius(radius), _stuck(true) { }

glm::vec2 BallObject::move(float dt, GLuint window_width){
