...
// Circle collision --Specially for BallObject
inline GLboolean CheckCollision(BallObject &one, GameObject &two);
...
inline GLboolean CheckCollision(BallObject &one, GameObject &two){ // AABB - Circle collision
